                                        ...
                                        state.stacks.length === 0 ? (
                                            ...
                                            visibleStacks.map((stack) => (
                                                <NoteStackColumn
                                                    ...
                                                    onDeleteStack={
                                                        state.handleDeleteStack
                                                    }
                                                    onOpenGroup={
                                                        state.handleOpenGroup
                                                    }
                                                    onInitiateCreateNote={
                                                        state.handleInitiateCreateNote
                                                    }
                                                    onOpenNote={
                                                        state.handleOpenNote
                                                    }
                                                    onDeleteGroup={
                                                        state.handleDeleteGroup
                                                    }
                                                    onDeleteNote={
                ...
                {state.isCreatingStack ? (
                    <div className="bg-surface/95 backdrop-blur p-4 rounded-lg shadow-xl border border-gray-400 flex flex-col gap-2">
                        <input
                            ...
                            onChange={(e) =>
                                state.setDraftStackTitle(e.target.value)
                            }
                            onKeyDown={(e) =>
                                e.key === "Enter" &&
            ...
            {state.formState.isOpen && state.formState.groupId && (
                <NotesFormUI
                    ...
                    onSave={async (
                        ...
                        const targetGroupId =
                            newGroupId || state.formState.groupId!;
